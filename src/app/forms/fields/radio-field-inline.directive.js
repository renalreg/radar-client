import templateUrl from './radio-field-inline.html';

function frmRadioFieldInline(wrapRadioOptions, toRadioView, toRadioModel) {
  return {
    restrict: 'A',
    scope: {
      model: '=',
...
frmRadioFieldInline.$inject = ['wrapRadioOptions', 'toRadioView', 'toRadioModel'];

export default frmRadioFieldInline;
