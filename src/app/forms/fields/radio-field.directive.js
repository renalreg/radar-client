import templateUrl from './radio-field.html';

function frmRadioField(wrapRadioOptions, toRadioView, toRadioModel) {
  return {
    restrict: 'A',
    scope: {
      model: '=',
...
frmRadioField.$inject = ['wrapRadioOptions', 'toRadioView', 'toRadioModel'];

export default frmRadioField;
